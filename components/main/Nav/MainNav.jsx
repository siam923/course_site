...
const MainNav = () => {
  ...
  return (
    <nav className="relative z-10 bg-black bg-opacity-35  text-white shadow-lg">
            ...
            <div className="hidden md:flex ml-10 space-x-8">
              {navLinks.map((linkItem, index) => (
                <Link
                  href={linkItem.link}
                  key={index}
                  className="font-semibold hover:text-[#721915]"
                >
                  {linkItem.title}
                </Link>
              ))}
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {navLinks.map((linkItem, index) => (
              <Link
                href={linkItem.link}
                key={index}
                className="block py-2 px-4 font-semibold text-white hover:text-gray-3600"
              >
                {linkItem.title}
              </Link>
            ))}
